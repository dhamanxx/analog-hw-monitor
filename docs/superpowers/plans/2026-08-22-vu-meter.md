...
**Tech Stack:** C# / .NET 8 (`net8.0-windows`), WinForms, xUnit, `NAudio.Wasapi` (MIT), `System.TimeProvider`.
...
- Target framework `net8.0-windows`, `Nullable enable`, `ImplicitUsings enable`. Comments explain *why*, matching the density of the surrounding code.
